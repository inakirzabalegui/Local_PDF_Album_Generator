...
const TRANSLATIONS = {
  es: {
    ...
    'help.action_shuffle': '🎲 Aleatorio — reordena visualmente las fotos con una nueva semilla (tecla A)',
  ...
  en: {
    ...
    'help.action_shuffle': '🎲 Shuffle — re-randomizes photo positions with a new layout seed (A key)',
