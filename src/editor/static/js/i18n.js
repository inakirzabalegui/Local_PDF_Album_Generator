...
const TRANSLATIONS = {
  es: {
    ...
    'album.layout_cuadricula_uniforme': 'Cuadrícula uniforme',
    'album.layout_cuadricula_compacta': 'Cuadrícula compacta',
    'album.layout_cuadricula_maximizada': 'Cuadrícula maximizada',
    'album.apply_layout': '⚙️ Aplicar Modo',
    'toast.layout_mode': 'Modo: ',
    'toast.shuffled': '🎲 Aleatorio',
    ...
    'error.reorder_cross_section': 'No se pueden mover páginas entre eventos distintos',
    'error.reorder_pages': 'Error al reordenar páginas: ',
    'error.connection_reorder_pages': 'Error de conexión al reordenar páginas',
    'success.pages_reordered': 'Páginas reordenadas.',
    ...
    'confirm.delete_page_last_in_section_title': 'Borrar última página del evento',
    'confirm.delete_page_last_in_section_message': 'Esta es la última página del evento «{{ title }}». Si la borras, el evento desaparecerá del álbum (las fotos de origen no se tocan). ¿Continuar?',
    ...
    'success.page_deleted': 'Página borrada. Las páginas siguientes han sido renumeradas.',
    ...
    'help.flow_5': 'Los cambios se guardan automáticamente; exporta el PDF desde la línea de comandos',
    ...
    'help.key_rename': 'Renombrar evento',
    'help.scope_source': 'Fuente',
    'help.key_delete': 'Borrar foto seleccionada (o foto actual en el visor)',
    'help.key_delete_event': 'Borrar evento completo (pide confirmación)',
    'help.key_view': 'Abrir visor a pantalla completa (↑/↓ navega, D borra)',
    'help.key_show': 'Vista pantalla completa de la página (↑/↓/←/→ navega)',
    'page_show.page': 'Página',
    'page_show.nav_hint': '← → navegar  ·  V fotos  ·  L layout  ·  S / Esc cerrar',
    'photo_viewer.nav_hint': '↑ ↓ navegar  ·  D borrar  ·  S página  ·  Esc cerrar',
    'help.key_shuffle': 'Reordenar aleatoriamente las fotos de la página (también en Show)',
    'help.key_layout': 'Cambiar al siguiente modo de layout (Shift+L: anterior)',
    'help.key_explode': 'Explotar página en dos (útil si hay demasiadas fotos)',
    ...
    'help.key_nav_state': 'Saltar al siguiente cambio de estado en el panel (completadas/pendientes)',
    ...
    'help.action_rename_event': '✏️ Renombrar Evento (R) — cambia el nombre y renombra las fotos automáticamente',
    'help.action_delete_event': '🗑️ Borrar Evento (X) — elimina la carpeta de evento completa con confirmación',
    'help.action_delete_source_photo': '🗑️ Borrar Foto (D) — elimina la foto seleccionada del origen (también en el visor)',
    'help.action_view_source': '🔍 Visor (V) — abre la foto en pantalla completa; navega con ↑/↓, borra con D',
    'help.action_complete_event': '✅ Completado (C) — marca el evento como revisado (punto verde)',
    'help.action_sync': '🔄 Sincronizar — detecta cambios en el origen y actualiza el workspace sin perder ediciones',
    ...
    'help.action_shuffle': '🎲 Aleatorio — reordena visualmente las fotos con una nueva semilla (tecla A, también en Show)',
  ...
  en: {
    ...
    'album.layout_cuadricula_uniforme': 'Uniform Grid',
    'album.layout_cuadricula_compacta': 'Compact Grid (preserve)',
    'album.layout_cuadricula_maximizada': 'Maximized Grid (crop)',
    'album.apply_layout': '⚙️ Apply Mode',
    'toast.layout_mode': 'Mode: ',
    ...
    'error.reorder_cross_section': "Pages can't be moved across different events",
    'error.reorder_pages': 'Error reordering pages: ',
    'error.connection_reorder_pages': 'Connection error reordering pages',
    'success.pages_reordered': 'Pages reordered.',
    ...
    'confirm.delete_page_last_in_section_title': 'Delete last page of event',
    'confirm.delete_page_last_in_section_message': 'This is the last page of event «{{ title }}». Deleting it will remove the event from the album (source photos are not touched). Continue?',
    ...
    'success.page_deleted': 'Page deleted. Subsequent pages have been renumbered.',
    ...
    'help.flow_5': 'Changes save automatically; export the PDF from the command line',
    ...
    'help.key_rename': 'Rename event',
    'help.scope_source': 'Source',
    'help.key_delete': 'Delete selected photo (or current photo in viewer)',
    'help.key_delete_event': 'Delete entire event (asks for confirmation)',
    'help.key_view': 'Open full-screen photo viewer (↑/↓ navigate, D delete)',
    'help.key_show': 'Full-screen page view (↑/↓/←/→ navigates)',
    'page_show.page': 'Page',
    'page_show.nav_hint': '← → navigate  ·  V photos  ·  L layout  ·  S / Esc close',
    'photo_viewer.nav_hint': '↑ ↓ navigate  ·  D delete  ·  S page  ·  Esc close',
    'help.key_shuffle': 'Shuffle photos on the page randomly (also in Show)',
    'help.key_layout': 'Switch to next layout mode (Shift+L: previous)',
    'help.key_explode': 'Explode page into two (useful when there are too many photos)',
    ...
    'help.key_nav_state': 'Jump to next state change in the panel (completed/pending)',
    'help.scope_global': 'Global',
    'help.scope_both': 'Source · Edition',
    'help.scope_edition': 'Edition',
    'help.section_source_actions': 'Source actions',
    'help.action_rename_event': '✏️ Rename Event (R) — changes the name and auto-renames photos inside',
    'help.action_delete_event': '🗑️ Delete Event (X) — removes the full event folder (asks for confirmation)',
    'help.action_delete_source_photo': '🗑️ Delete Photo (D) — removes the selected photo from the source (also works in viewer)',
    'help.action_view_source': '🔍 Viewer (V) — opens photo full-screen; navigate with ↑/↓, delete with D',
    'help.action_complete_event': '✅ Completed (C) — marks the event as reviewed (green dot)',
    'help.action_sync': '🔄 Sync — detects new/removed photos in the source and updates the workspace without losing edits',
    ...
    'help.action_shuffle': '🎲 Shuffle — re-randomizes photo positions with a new layout seed (A key, also in Show)',
